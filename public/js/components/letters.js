    ...
    buttonContinue.addEventListener('click', ()=> {
        ...
        if( final == false ) {
            ...
            setTimeout(()=> {
                ...
                textShow.innerHTML  = ''
                const text      = 'Al paso del tiempo hemos compartido recuerdos, fotos, juegos, musicas, videos algunas puedes verlos aqui, hermosos momentos juntos ❤️'
                let index       = 0
